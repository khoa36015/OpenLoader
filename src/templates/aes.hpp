...
__attribute__((unused)) static void _ec(const uint8_t* in,uint8_t* out,const uint8_t* w){
...
__attribute__((unused)) static void xorf(uint8_t* d,int l,const uint8_t* k,int kl){for(int i=0;i<l;i++)d[i]^=k[i%kl];}
}
